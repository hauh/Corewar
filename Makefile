...
#    Updated: 2019/09/17 23:26:31 by smorty           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_ASM := asm.c read_input.c parse_file.c parse_title.c parse_label.c parse_opcode.c parse_parameter.c analyze.c utility.c temp.c
